...
PROTOTXT = os.environ.get('YAWN_FACE_PROTOTXT', os.path.join(FACE_DETECTOR_DIR, 'deploy.prototxt'))
MODEL = os.environ.get('YAWN_FACE_MODEL', os.path.join(FACE_DETECTOR_DIR, 'res10_300x300_ssd_iter_140000.caffemodel'))

CASCADES_FILE = os.environ.get('YAWN_FACE_CASCADE', os.path.join(FACE_DETECTOR_DIR, 'lbpcascade_frontalface.xml'))
CASCADES = cv.CascadeClassifier(CASCADES_FILE)

NET = dnn.readNetFromCaffe(PROTOTXT, MODEL)
VIDEO = os.environ.get('YAWN_FACE_DEMO_VIDEO', '')
