...
def main():
    ...
    src_dir = os.environ.get('YAWN_LIST_SRC_DIR', os.path.join(project_root, 'extracted_face', 'face_image'))
    save_dir = os.environ.get('YAWN_LIST_SAVE_DIR', os.path.join(project_root, 'extracted_face'))
    lg.generate_list(src_dir=src_dir,
                     save_dir=save_dir)
    print("Done !!")
    # lg.save_list()
